...
set genomeRtd $env(RT_TMP)/356FE510.rtd
set parallel_map_command "rt::do_reinfer_area_combined 0"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {rom_array_layer_1__GB10}]"
...
set genomeName [subst -nocommands -novariables {rom_array_layer_1__GB10}]
