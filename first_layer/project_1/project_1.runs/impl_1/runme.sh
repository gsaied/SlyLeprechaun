...
HD_PWD='/home/gsaied/Desktop/verilog_rtl/first_layer/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log conv1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source conv1.tcl -notrace
