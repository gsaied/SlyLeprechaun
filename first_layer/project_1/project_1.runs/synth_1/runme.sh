...
HD_PWD='/home/gsaied/Desktop/verilog_rtl/first_layer/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log conv1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source conv1.tcl
