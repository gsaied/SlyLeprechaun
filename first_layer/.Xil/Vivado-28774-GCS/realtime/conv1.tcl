...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "./.Xil/Vivado-28774-GCS/realtime/tmp"
    ...
    set rt::SDCFileList ./.Xil/Vivado-28774-GCS/realtime/conv1_synth.xdc
    rt::sdcChecksum
    set rt::top conv1
...
# MODE: 
    rt::set_parameter webTalkPath {./.Xil/Vivado-28774-GCS/wt}
    rt::set_parameter enableSplitFlowPath "./.Xil/Vivado-28774-GCS/"
