...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "./.Xil/Vivado-9300-GCS/realtime/tmp"
...
# MODE: 
    rt::set_parameter webTalkPath {./.Xil/Vivado-9300-GCS/wt}
    rt::set_parameter enableSplitFlowPath "./.Xil/Vivado-9300-GCS/"
