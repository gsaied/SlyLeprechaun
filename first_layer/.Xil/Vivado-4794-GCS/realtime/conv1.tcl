...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "./.Xil/Vivado-4794-GCS/realtime/tmp"
...
# MODE: 
    rt::set_parameter webTalkPath {./.Xil/Vivado-4794-GCS/wt}
    rt::set_parameter enableSplitFlowPath "./.Xil/Vivado-4794-GCS/"
